...
from model.peliculas_dao import Pelicula, guardar, listar, editar, eliminar


def barra_menu(root):
    #Barra de menu, inicio consultas conf ayuda.
...
class Frame(tk.Frame):
    ...
    def campo_pelicula(self):
        #LAabels de cada campo: Nombre, duracion y genero
    ...
    def tabla_peliculas(self):
        ...
        #SCROLLBAR PARA LA TABLA, para poder bajar:
        ...
        self.boton_editar.config(width= 20, font= ('Arial', 12, 'bold'), bg= '#158645', fg= '#DAD5D6', cursor='hand2', activebackground= '#35bd6f')
        self.boton_editar.grid(row= 5, column= 0, padx=10, pady=10)

        #BOTON DE ELIMINAR
        self.boton_eliminar = tk.Button(self, text = "Eliminar", command= self.eliminar_datos)
        self.boton_eliminar.config(width= 20, font= ('Arial', 12, 'bold'), bg= '#bd152e', fg= '#DAD5D6', cursor='hand2', activebackground= '#e15370')
